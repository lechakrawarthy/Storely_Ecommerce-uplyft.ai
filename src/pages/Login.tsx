...
const Login = () => {
  ...
  const handleInputChange = (field: string, value: string) => {
    ...
    try {
      ...
      // Only navigate if login was actually successful (no errors in context)
      if (!error) {
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-0 left-0">
          <svg width="300" height="300" viewBox="0 0 300 300" fill="none">
            <path d="M0 0H300C134.315 0 0 134.315 0 300V0Z" fill="url(#gradient1)" />
            <defs>
        ...
        <div className="absolute top-0 left-0">
          <svg width="180" height="180" viewBox="0 0 180 180" fill="none">
            <path d="M0 0H180C80.5939 0 0 80.5939 0 180V0Z" stroke="url(#gradientStroke1)" strokeWidth="2" fill="none" />
            <defs>
              <linearGradient id="gradientStroke1" x1="0" y1="0" x2="180" y2="180" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute bottom-0 right-0 rotate-180">
          <svg width="280" height="280" viewBox="0 0 280 280" fill="none">
            <path d="M0 0H280C125.228 0 0 125.228 0 280V0Z" fill="url(#gradient2)" />
            <defs>
              <linearGradient id="gradient2" x1="0" y1="0" x2="280" y2="280" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute bottom-0 right-0 rotate-180">
          <svg width="160" height="160" viewBox="0 0 160 160" fill="none">
            <path d="M0 0H160C71.6344 0 0 71.6344 0 160V0Z" stroke="url(#gradientStroke2)" strokeWidth="1.5" fill="none" />
            <defs>
              <linearGradient id="gradientStroke2" x1="0" y1="0" x2="160" y2="160" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute top-1/2 left-0">
          <svg width="100" height="200" viewBox="0 0 100 200" fill="none">
            <path d="M0 0C55.2285 0 100 44.7715 100 100S44.7715 200 0 200" stroke="url(#accentGradient1)" strokeWidth="1" fill="none" opacity="0.3" />
            <defs>
              <linearGradient id="accentGradient1" x1="0" y1="0" x2="100" y2="200" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute bottom-0 right-1/2">
          <svg width="200" height="100" viewBox="0 0 200 100" fill="none">
            <path d="M0 100C0 44.7715 44.7715 0 100 0S200 44.7715 200 100" stroke="url(#accentGradient2)" strokeWidth="1" fill="none" opacity="0.2" />
            <defs>
              <linearGradient id="accentGradient2" x1="0" y1="100" x2="200" y2="0" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div className="absolute top-0 right-0">
            <svg width="220" height="220" viewBox="0 0 220 220" fill="none">
              <path d="M220 0V220C220 98.4975 121.502 0 0 0H220Z" fill="url(#rightGradient1)" />
              <defs>
                <linearGradient id="rightGradient1" x1="220" y1="0" x2="0" y2="220" gradientUnits="userSpaceOnUse">
          ...
          <div className="absolute bottom-0 left-0 rotate-180">
            <svg width="180" height="180" viewBox="0 0 180 180" fill="none">
              <path d="M180 0V180C180 80.5939 99.4061 0 0 0H180Z" fill="url(#rightGradient2)" />
              <defs>
                <linearGradient id="rightGradient2" x1="180" y1="0" x2="0" y2="180" gradientUnits="userSpaceOnUse">
        ...
        <div className="relative z-10 text-white max-w-lg">          {/* Main Heading */}
          ...
          <div className="mb-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-green-100">Customer Experience Manager</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold">Shop Electronics, Books & Textiles</h3>
