            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className={`${viewMode === 'grid'
                    ...
                    {currentProducts.map(product => (
                        <div key={product.id}>
                            {/* Mobile Product Cards (< lg screens) */}
            ...
            <MobileFiltersSheet
                ...
                filters={[
                    ...
                    },
                    {
                        ...
                        title: 'Sort By',
                        type: 'radio',
                        options: sortOptions.map(sort => ({ id: sort, label: sort })),
                        value: sortBy
                    }
                ]}
                onFiltersChange={(filters) => {
                    filters.forEach((filter: any) => {
                        if (filter.id === 'category') setSelectedCategory(filter.value);
                        if (filter.id === 'price') setPriceRange(filter.value);
                        if (filter.id === 'sort') setSortBy(filter.value);
                    });
                }}
                onClearAll={() => {
