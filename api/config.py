...
class Config:
    ...
    MAX_PRODUCTS_PER_RESPONSE = int(os.environ.get('MAX_PRODUCTS_PER_RESPONSE') or 6)
    MAX_SUGGESTIONS_PER_RESPONSE = int(os.environ.get('MAX_SUGGESTIONS_PER_RESPONSE') or 6)
